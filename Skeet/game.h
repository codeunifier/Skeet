...
public:
   ...
   //getter and setter for the frozen variable
   bool getFrozen();
   void setFrozen(bool);
...
private:
   ...
   //when frozen is true, the game will be frozen and the game menu
   //	will be dispalyed until the user presses the enter key
   void displayMenu();
   bool frozen;
